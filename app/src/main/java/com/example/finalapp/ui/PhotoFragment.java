...
import com.example.finalapp.models.PostModel;
...
public class PhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        camera = root.findViewById(R.id.btn_camera_photo);
        upload = root.findViewById(R.id.btn_upload_photo);
        photo_layout = root.findViewById(R.id.ll_labels_photo);
        img= root.findViewById(R.id.img_photo_photo);
        getLabel();
